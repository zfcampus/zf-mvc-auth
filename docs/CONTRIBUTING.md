...
[create a proposal](https://github.com/zfcampus/zf-mvc-auth/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zfcampus/zf-mvc-auth.git
  $ cd zf-mvc-auth
  ```
...
2. Fork the repository (https://github.com/zfcampus/zf-mvc-auth)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zf-mvc-auth.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zf-mvc-auth.git
